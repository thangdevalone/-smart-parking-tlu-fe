...
import { Card, DialogActionType } from '@/types';
...
export function CardHandler(props: CardTypeRowActionsProps) {
  const {
    row,
  } = props;
  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent align="center" className="w-[160px]">
        <DropdownMenuItem className="cursor-pointer" onClick={() => setDialogState(KeyDialogs.card, {
          open: true,

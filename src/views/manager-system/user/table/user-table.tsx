...
import { UserToolbar } from '@/views/manager-system/user/table/user-toolbar.tsx';
...
export function UserTable() {
  ...
  const { data, isFetching } = useUserFetcher({
  ...
  return (
    <div className="gap-4 h-full flex flex-col">
      <UserToolbar table={table} query={query} setQuery={setQuery} />
